...
public class VerletRope : MonoBehaviour
{
    ...
    private void ApplyConstraints()
    {
        ...
        for (int i = 1; i < _ropeSegmentAmount - 1; i++)
        {
    ...
    {
        Vector2 currentSegmentPosition = _ropeSegments[ropeSegmentIndex].CurrentPosition;
        Vector2 nextSegmentPosition = _ropeSegments[ropeSegmentIndex + 1].CurrentPosition;

        Vector2 differenceVector = currentSegmentPosition - nextSegmentPosition;
